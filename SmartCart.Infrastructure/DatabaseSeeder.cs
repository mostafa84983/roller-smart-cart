        ...
        if (!context.Products.Any())
        {
            ...
            var products = new List<Product>
            {
                new Product
                {
                    ...
                    ProductDescription = "Alarousa Black Tea - 250g pack",
                    IsAvaiable = true,
                ...
                new Product
                {
                    ...
                    Quantity = 100,
                    ProductPrice = 18.00m,
                    ProductImage = "coca_cola_can.jpg",
                    ProductDescription = "Coca-Cola Can - 330ml",
                    IsAvaiable = true,
                    CategoryId = categories.First(c => c.CategoryName == "Beverages").CategoryId,
                    IsOffer = false,
                    OfferPercentage = 0m
                ...
                new Product
                {
                    ...
                    Quantity = 100,
                    ProductPrice = 18.00m,
                    ProductImage = "7up_can.jpg",
                    ProductDescription = "7up Can - 330ml",
                    IsAvaiable = true,
                    CategoryId = categories.First(c => c.CategoryName == "Beverages").CategoryId,
                    IsOffer = false,
                    OfferPercentage = 0m
                ...
                new Product
                {
                    ...
                    Quantity = 100,
                    ProductPrice = 12.00m,
                    ProductImage = "windows.jpg",
                    ProductDescription = "Windows Snacks - 50g",
                    IsAvaiable = true,
                    CategoryId = categories.First(c => c.CategoryName == "Snacks").CategoryId,
                    IsOffer = false,
                    OfferPercentage = 0m
                ...
                new Product
                {
                    ...
                    ProductWeight = 0.05m,
                    Quantity = 100,
                    ProductPrice = 10.00m, // Adjusted to 10.00 EGP
                ...
                new Product
                {
                    ...
                    Quantity= 100,
                    ProductPrice = 15.00m, // Updated based on Amazon link
